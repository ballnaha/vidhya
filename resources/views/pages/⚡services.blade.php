    ...
    <section class="px-6 py-20 sm:px-10 lg:px-20">
        <div class="mx-auto max-w-[1800px] space-y-[3px]">
            @foreach ([
                ...
                ['03', 'Post Production', 'Cinematic finishing at scale. We take your hero films and expertly craft high quality variations to feed your entire marketing funnel.', ['Cinematic colour grading', 'Multi-format variations', 'Full funnel asset delivery', 'Broadcast-ready output'], '#e60012', '/images/services/post.webp'],
                ['04', 'AI Models & Influencers', 'Bespoke persona development and digital character creation for highly targeted brand representation.', ['Custom AI persona creation', 'Brand-aligned characters', 'Scalable digital talent', 'Consistent brand voice'], '#366bc3', '/images/services/services_models.jpg'],
                ['05', 'AI Marketing Content', 'High volume visual assets engineered for daily engagement across social media and ecommerce platforms.', ['High volume production', 'Social & ecommerce formats', 'Daily engagement assets', 'Brand-consistent output'], '#823665', '/images/services/services_marketing.jpg'],
                ['06', 'Micro Drama', 'Highly engaging episodic digital narratives infused with our cinematic perspective and deep storytelling heritage.', ['Episodic narrative series', 'Cinematic storytelling', 'Platform-native formats', 'Audience retention focus'], '#e60012', '/images/services/services_drama.jpg'],
                ['07', 'Training & Workshop', 'Hands on workshops to empower your team to understand and utilize proven AI driven media workflows.', ['Team capability building', 'AI workflow training', 'Hands-on sessions', 'Custom curriculum'], '#366bc3', '/images/services/services_training.jpg'],
                ['08', 'Strategic Consulting', 'Leveraging our wider ecosystem, we consult on content creation and strategy, ensuring your pipeline drives measurable business results.', ['Full pipeline strategy', 'Ecosystem integration', 'KPI-aligned frameworks', 'Ongoing advisory'], '#823665', '/images/services/services_consulting.jpg'],
            ] as [$num, $title, $desc, $bullets, $accent, $img])
                <article class="home-animated-card hover-border-accent flex flex-row items-stretch overflow-hidden border-l-[3px] bg-[#0c0c12] hover:bg-[#0f0f18]" data-reveal style="--card-accent: {{ $accent }}; --reveal-delay: {{ $loop->index * 50 }}ms;">
                    <div class="relative shrink-0 w-28 sm:w-40 lg:w-[200px] xl:w-[240px] bg-black aspect-[2/3]" style="aspect-ratio: 2/3;">
                        ...
                        <!-- Subtle overlay matching card accent -->
